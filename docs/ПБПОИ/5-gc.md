---
title: 5. Устройство JVM. Сборщик мусора (GC)
summary: Устройство JVM. Сборщик мусора (GC)
authors:
    - Оболенский Д.М.
---
...
![Рисунок 1. Подробная архитектура JVM](../assets/images/ПБПОИ/shared/java-architecture-2.png)

*Рисунок 1. Архитектура JVM*
