...
![Рисунок 2.2. Основное окно системы](../assets/images/ПБПОИ/lab1/2.png)
...
![Рисунок 2.3. Окно текстового редактора](../assets/images/ПБПОИ/lab1/3.png)
...
![Рисунок 2.4. Окно проекта. Открыто контекстное меню класса](../assets/images/ПБПОИ/lab1/4.png)
...
![Рисунок 2.5. Окно терминала. Результат выполнения программы](../assets/images/ПБПОИ/lab1/5.png)
