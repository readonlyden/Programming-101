...
Создадим текстовый файл `Main.java` со следующим содержанием:
![Простейшая программа](../assets/images/ПБПОИ/shared/java-cmd-1.png)
...
![Результат компиляции и запуска](../assets/images/ПБПОИ/shared/java-cmd-2.png)
...
![Рисунок 5. Среда BlueJ](../assets/images/ПБПОИ/shared/bluej.png)

*Рисунок 5. Среда BlueJ*

Основное окно системы *BlueJ* показано на рисунке 6. 

![Рисунок 6. Основное окно BlueJ](../assets/images/ПБПОИ/lab1/bluej_ide.jpg)
...
![Рисунок 7. Окно текстового редактора](../assets/images/ПБПОИ/lab1/bluej_editor.jpg)
...
![Рисунок 8. Контекстное меню класса](../assets/images/ПБПОИ/lab1/bluej_run.jpg)

*Рисунок 8. Контекстное меню класса и доступные методы, в т.ч. метод `main`*

Результат работы программы выводятся в окно терминала (рисунок 9). (Если окна терминала нет, в главном окне выберите *Виды* – *Показать терминал*). 

![Рисунок 9. Окно терминала. Результат выполнения программы](../assets/images/ПБПОИ/lab1/bluej_result.jpg)
...
При создании проекта мы можем увидеть следующее окно (рисунок 10). Здесь мы можем создать новый проект (рисунок 11), открыть уже созданный, либо открыть проект из системы контроля версий. Подробнее про создание проекта можно почитать в официальном [туториале](https://www.jetbrains.com/help/idea/creating-and-running-your-first-java-application.html). 

Главное окно среды показано на рисунке 12.

![Рисунок 10. Приветственное окно](../assets/images/ПБПОИ/shared/intellij-new-project.png)

*Рисунок 10. Среда IntelliJ IDEA*

![Рисунок 11. Окно создания нового проекта](../assets/images/ПБПОИ/shared/intellij-new-project2.png)

*Рисунок 11. Среда IntelliJ IDEA*

![Рисунок 12. Среда IntelliJ](../assets/images/ПБПОИ/shared/intellij.png)
...
![Рисунок 13. Граф задач Gradle](../assets/images/ПБПОИ/shared/gradle-dag.png)
...
![Рисунок 14. Запуск при помощи терминала Windows Terminal](../assets/images/ПБПОИ/shared/gradle-terminal.png)
...
![Рисунок 15. Меню Gradle в IntelliJ IDEA](../assets/images/ПБПОИ/shared/gradle-intellij.png)

*Рисунок 15. Меню Gradle в IntelliJ IDEA*

![Рисунок 16. Результат запуска Gradle в IntelliJ](../assets/images/ПБПОИ/shared/gradle-intellij-run.png)
